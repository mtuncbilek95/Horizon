...
namespace Horizon
{
	...
	struct ImageBarrierDesc
	{
		...
		PipelineStageFlags srcStage = PipelineStageFlags::Auto;
		PipelineStageFlags dstStage = PipelineStageFlags::Auto;
		AccessFlags srcAccess = AccessFlags::Auto;
		AccessFlags dstAccess = AccessFlags::Auto;
		...
		ImageBarrierDesc& setOldStage(PipelineStageFlags f) { srcStage = f; return *this; }
		ImageBarrierDesc& setNewStage(PipelineStageFlags f) { dstStage = f; return *this; }
		ImageBarrierDesc& setOldAccess(AccessFlags f) { srcAccess = f; return *this; }
		ImageBarrierDesc& setNewAccess(AccessFlags f) { dstAccess = f; return *this; }
